...
1.  Reactive UI components (Done: `Window_HUD` and `Window_Party` refactored to use EventBus).
2.  Audio system integration (Done: `AudioManager` implemented and registered).
