...
> **Implementation Gap:** Current `Game_Action.calcElementRate` uses a hardcoded cycle (Green/Blue/Red/White/Black) rather than the flexible alignment array described here.
