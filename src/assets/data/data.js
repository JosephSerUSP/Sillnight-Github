...
export const Data = {
    ...
    // Animation registry: motion, vfx, and action sequences for battle choreography.
    motionClips: {
        jumpSmall: {
            steps: [
        ...
        castSpellLarge: {
            steps: [
                { type: 'verticalSine', axis: 'z', amplitude: 0.5, speed: 0.4, durationFrames: 36, intervalFrames: 2 }
            ]
        },
        liftAndBounceBig: {
            defaults: {
    ...
    actionSequences: {
        ...
        cure: {
            sequence: [
                { kind: 'motion', who: 'caster', clip: 'jumpSmall' },
                { kind: 'forEachTarget', mode: 'sequential', steps: [ { kind: 'vfx', clip: 'cureFlash', who: 'target' }, { kind: 'effect' } ] }
            ]
        }
    },
