...
export const Data = {
    ...
    skills: {
        wait:   { id: 'wait',   name: 'Wait',        category: 'effect', target: 'self',         speed: 2,  effect: 'wait',  animation: 'wait' },
        attack: { id: 'attack', name: 'Attack',      category: 'damage', target: 'enemy-single', speed: 0,  power: 4, scaling: 2,   animation: 'flash' },
        guard:  { id: 'guard',  name: 'Guard',       category: 'effect', target: 'self',         speed: 2,  effect: 'guard', animation: 'wait' },

        attackRow: { id: 'attackRow', name: 'Attack Row', category: 'damage', target: 'enemy-row',   speed: 0,  power: 3, scaling: 1.5, animation: 'flash' },
        cure:      { id: 'cure',      name: 'Cure',       category: 'heal',   target: 'ally-single', speed: 1,  power: 4, scaling: 2,   element: 'W', animation: 'healSingle' },
    ...
    actionSequences: {
        demoFull: {
            sequence: [
                ...
                {
                    kind: 'vfx',
                    clip: 'basicHitDefaults',
                    who: 'world',
                    waitForEffekseerOverride: true
                },
                    ...
                    steps: [
                        {
                            kind: 'parallel',
                            steps: [
                                { kind: 'motion', who: 'target', clip: 'liftAndBounceBig', overrides: { height: 2.5 } },
