...
export class Game_BattlerBase {
    ...
    set hp(value) {
        ...
        this.refresh();
        if (Services.events) {
            Services.events.emit('battler:change', { unit: this, property: 'hp', value: this._hp, diff: diff });
        }
    ...
    set mp(value) {
        ...
        this.refresh();
        if (Services.events) {
            Services.events.emit('battler:change', { unit: this, property: 'mp', value: this._mp, diff: diff });
        }
    }
    ...
    set tp(value) {
        ...
        this.refresh();
        if (Services.events) {
            Services.events.emit('battler:change', { unit: this, property: 'tp', value: this._tp, diff: diff });
        }
    }
