...
export class ExploreSystem {
    ...
    updateFogTarget() {
        ...
        for (let y = 0; y < h; y++) {
            ...
            for (let x = 0; x < w; x++) {
                ...
                this.fogTarget[texRow * w + x] = visited ? 255 : 0;
            }
        }
    }
    ...
    animate() {
        ...
        if (this.fogValues && this.fogTarget && this.fogTexture) {
            ...
            const lerpFactor = 0.1; // Adjust for fade speed
            const threshold = 1.0;
