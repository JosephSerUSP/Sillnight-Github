...
export const BattleManager = {
    ...
    processNextTurn() {
         window.Game.Windows.Party.refresh();
            ...
            const results = action.apply(targets[0]);
            // Note: Currently action.apply takes single target or loops inside?
            // Game_Action.apply takes a single target and returns results for that target.
            // If we have multiple targets, we should loop.
