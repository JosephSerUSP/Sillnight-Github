...
import { createUI } from './windows.js';
    ...
    Battle: {
        ...
        startEncounter() {
            ...
            setTimeout(() => {
                ...
                const handledByScene = !!Systems.sceneHooks?.enterBattle;
                if (handledByScene) Systems.sceneHooks.enterBattle();
                if (!handledByScene) Systems.UI.switchScene(true);
                // Reset camera state
