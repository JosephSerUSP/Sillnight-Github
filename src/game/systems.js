    ...
    */
    Battle: {
        ...
        startEncounter() {
            ...
            // Begin round once the scene transition finishes
            setTimeout(() => Systems.Battle.nextRound(), 1200);
        },
        nextRound() {
        ...
        processNextTurn() {
            ...
            if (win) {
                ...
                UI.showModal(`
                    ...
                    <button class="mt-4 border border-white px-4 py-2 hover:bg-gray-800" onclick="Game.Systems.Battle.completeVictory();">CONTINUE</button>
                `);
            } else {
        ...
        completeVictory() {
            if (GameState.ui.mode !== 'BATTLE_WIN') return;
            GameState.ui.mode = 'EXPLORE';
            UI.closeModal();
