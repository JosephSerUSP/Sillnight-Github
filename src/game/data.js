...
pixie: { id: 'pixie', name: 'Pixie', description: "A flicker of innocent light in the deep gloom. Their minds know no distinction between the conscious and unconscious, and as such, they say as they please.", sprite: '🧚', spriteAsset: 'assets/images/creatures/pixie.png', baseHp: 12, hpGrowth: 0.15, xpCurve: 10, baseXp: 2, cost: 100, temperament: 'kind', acts: [ ['attack'], ['cure'] ] },
        ...
        lich: { id: 'lich', name: 'Lich', description: "A sorcerer who cheated death by shackling their soul to a physical vessel. Their power grows with every blasphemous ritual, and their gaze is eternal winter.", sprite: '🩻', spriteAsset: 'assets/images/creatures/lich.png', baseHp: 35, hpGrowth: 0.28, xpCurve: 22, baseXp: 12, cost: 600, temperament: 'ruthless', acts: [ ['curse'], ['attack'] ] },
        stargazer: {
            id: 'stargazer',
            name: 'Stargazer',
        ...
        shadowServant: {
            ...
            sprite: '👤',
            spriteAsset: 'assets/images/creatures/shadow_servant.png',
            baseHp: 34,
            hpGrowth: 0.27,
            xpCurve: 18,
            baseXp: 10,
